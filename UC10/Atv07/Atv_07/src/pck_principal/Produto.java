...
public class Produto {
    private int cd_produto; //Variavel do BD
    private String ds_produto;//Variavel do BD
    private double vl_produto;//Variavel do BD
    private double qt_produdo;//Variavel do BD
    private int cd_unidade;//Variavel do BD
